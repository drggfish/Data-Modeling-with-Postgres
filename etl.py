...
def process_log_file(cur, filepath):
    ...
    time_data = []
    for ts in t:
        time_data.append([ts, ts.hour, ts.day, ts.week, ts.month,
                          ts.year, ts.day_name()])
...
def main():
    """" Main function used to run work flow.  Initially it sets up the
         connection object to the sparkifydb. Subsequently it makes two
         calls to the process_data function to process the song and log
         data files.
         Arguments:
           None
        Returns:
